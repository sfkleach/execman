# Execman coding guidelines

Execman is a command-line tool that helps find, download and install standalone executable applications.
...
- When testing the behaviour of a binary, such as execman, always use 
  `go run ./cmd/execman` rather than `./execman` directly. 
